...
# ----------------------------------------------------------------------------
# Create a series object using dates as the index and prices as values
ser = pd.Series(prices, index=es)
# print(ser)
...
#   Slicing series
# ----------------------------------------------------------------------------
# For demonstration purposes, slicing from the 3rd to the 7th element.
prcs = ser[2:7]
# print(prcs)
